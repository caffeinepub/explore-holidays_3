...
export class Backend implements backendInterface {
    ...
    async addDestination(arg0: Destination): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addDestination(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addPackage(arg0: Package): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getDestinationsByMaxPrice(arg0: bigint): Promise<Array<Destination>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDestinationsByMaxPrice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDestinationsByType(arg0: string): Promise<Array<Destination>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDestinationsByType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFavorites(): Promise<Array<Destination>> {
        if (this.processError) {
            try {
    ...
    async updateDestination(arg0: bigint, arg1: Destination): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDestination(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePackage(arg0: bigint, arg1: Package): Promise<void> {
        if (this.processError) {
            try {
